...
export const SPOTIFY_REDIRECT_URI = "http://164.92.98.110:3000/spotify/callback"
export const SPOTIFY_SCOPES = "user-read-private streaming user-read-playback-state user-read-currently-playing"